    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header row">
                <div class="card-title h3 col-8">Edit Instruktur</div>
                <div class="col-4">
            ...
            ?>
            <div class="card-body">
                <form action="?m=instruktur&s=update" method="post">
                    <div class="mb-3">
                        <input type="text" name="nip" value="<?=$r['nip']?>" class="form-control" placeholder="Nomo Induk Santri" required autofocus>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <select name="subject_id" class="form-control" required>
                            ...
                            ?>
                            <option value="<?=$r2['id']?>" <?=$r2['id']==$r['subject_id'] ? 'selected' : '' ?>><?=$r2['name']?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="mb-3">
